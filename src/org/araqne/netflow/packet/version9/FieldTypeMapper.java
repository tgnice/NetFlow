...
public class FieldTypeMapper {
	...
	FieldTypeMapper()
	{
		...
		field.put(FieldTypes.FLOW_SAMPLER_RANDOM_INTERVAL , new FlowSamplerRandomInterval());
		...
		field.put(FieldTypes.APPLICATION_DESCRIPTION , new ApplicationDescription());
		field.put(FieldTypes.APPLICATION_TAG , new ApplicationTag());
		field.put(FieldTypes.APPLICATION_NAME , new ApplicationName());
		field.put(FieldTypes.postipDiffServCodePoint , new PostDiffservCodePoint());
		field.put(FieldTypes.replication_factor , new ReplicationFactor());
		field.put(FieldTypes.DEPRECATED , new FieldDeprecated());
		field.put(FieldTypes.layer2packetSectionOffset , new Layer2PacketSectionOffset());
		field.put(FieldTypes.layer2packetSectionSize , new Layer2PacketSectionSize());
		field.put(FieldTypes.layer2packetSectionData , new Layer2PacketSectionData());
